...
def load_setting():
    settings = {
        ...
        'Primary site': {'values': ["Extremity", "Axial skeleton", "Other"], 'type': 'selectbox', 'init_value': 1,
                         'add_after': ''},
        'Histological type': {'values': ["Conventional", "Dedifferentiated"], 'type': 'selectbox', 'init_value': 0,
                              'add_after': ''},
        'Grade': {
